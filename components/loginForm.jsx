        ...
        <div className="flex items-center xl:p-10">
          <form className="border-t-4 border-black bg-black flex flex-col w-full h-full justify-center text-center rounded-lg shadow-lg">
           ...
           <div  className=" w-full  bg-blue-gray-50 mb-4">
              ...
              <input id="email" type="email" placeholder="mail@loopple.com" className=" mb-4 flex items-center w-full px-5 py-4 mr-2 text-sm font-medium outline-none focus:bg-grey-400 placeholder:text-grey-700 bg-grey-200 text-dark-grey-900 rounded-2xl"/>
              </div>
              <div className=" m-4 text-left">
              ...
              <div className=" m-4 text-left">
                <button className="w-full h-12 px-6 py-5 mb-5 text-sm font-bold leading-none text-white transition duration-300 md:w-96 rounded-2xl hover:bg-purple-blue-600 focus:ring-4 focus:ring-purple-blue-100 bg-black">Login</button>
              </div>
